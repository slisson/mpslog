...
<model ref="r:4a0ff1e4-1fb5-484f-a944-6b873b5a9472(test.de.q60.delta.mpslog.entities.editor)">
  ...
  <imports>
    <import index="qdc2" ref="r:a0e6fd46-d0d0-4a82-a064-20772089b9b1(test.de.q60.delta.mpslog.entities.structure)" implicit="true" />
